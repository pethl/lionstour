...
class FixturesControllerTest < ActionController::TestCase
  ...
  test "should create fixture" do
    assert_difference('Fixture.count') do
      post :create, fixture: { awayteam: @fixture.awayteam, hometeam: @fixture.hometeam, location: @fixture.location, matchdate: @fixture.matchdate, test: @fixture.test }
    end
  ...
  test "should update fixture" do
    put :update, id: @fixture, fixture: { awayteam: @fixture.awayteam, hometeam: @fixture.hometeam, location: @fixture.location, matchdate: @fixture.matchdate, test: @fixture.test }
    assert_redirected_to fixture_path(assigns(:fixture))
  end
